                            ...
                            <div class="invoice p-3 mb-3">
                                ...
                                <div class="row invoice-info" style="font-size:16px;">
                                    ...
                                    <div class="col-sm-4 invoice-col">
                                        ...
                                        <label for="supplier_id"
                                            style="margin-bottom: 5px;"><b>Project:</b></label>
                                ...
                                <!-- Table row -->
                                <div class="row" style="font-size:medium; margin-top:40px; background-color:#9cbac0;">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><input type="button" id="clearAll" value="Clear"
                                                            style="background-color: lightgray" /></th>
                                                </tr>
                                                <tr>
                                                    <th></th>
                                                    <th>
                                                    ...
                                                    <th><input type="text" name="price" id="price"
                                                            style="width: 150px; background-color: lightgray" /></th>
                                                    ...
                                                    <th></th>
                                                    <th><input type="button" style="background-color: lightgray"
            ...
            <script>
                $(function() {
                    ...
                    console.log(subTotal);  
                        ...
                        // let total_discount = discount * price;
