...
<main>
    <div style="justify-content:space-between; display:flex; padding:4px">
        <div>
            <ul class="breadcrumbs">
                ...
                <li><a class="btn btn-light" href="{{ route('status.create') }}">Create Statu</a></li>
            </ul>
        </div>
        <div>
    ...
    <form action="{{route('status.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="descriptions" id="descriptions" placeholder="descriptions">
            </div>
        </div>
