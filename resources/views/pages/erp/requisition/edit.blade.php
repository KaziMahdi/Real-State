...
@section('page')
<form id="requisitionForm" action="{{ route('requisitions.update', $requisition) }}" method="post" enctype="multipart/form-data">
	@csrf
	@method('PUT')
                                ...
                                <div class="row" style="margin-top: 30px;font-size:medium">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="remark" value="{{ $requisition->remark }}"
                                            name="remark" style="width: 150px; height:50px; padding-left:4px; border-radius: 5px; border: 1px solid black;"/>
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-6">
